        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              kişisel verileriniz hassasiyetle korunmaktadır.
            </p>
          </div>
        </div>
      </div>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 bg-white text-gray-700">
        <h2 className="text-2xl font-bold mb-4">Gizlilik Politikası</h2>
        <p className="mb-4">Son güncellenme: 24/03/2025</p>
        <p className="mb-4">
          Fizyotto Tokat olarak, güvenliğiniz bizim için önemlidir. Bu sebeple
          bizimle paylaşacağınız kişisel verileriniz hassasiyetle korunmaktadır.
          Bu Gizlilik Politikası, hangi kişisel verilerinizin hangi amaçla
          işleneceği, işlenen verilerin kimlerle ve neden paylaşılabileceği,
          veri işleme yöntemimiz ve hukuki sebeplerimiz ile; işlenen
          verilerinize ilişkin haklarınızın neler olduğu hususunda sizleri
        ...
        <ul className="list-disc list-inside mb-4">
          <li className="mb-2">Kişisel veri işlenip işlenmediğini öğrenme,</li>
          <li className="mb-2">
        ...
        <p className="mb-4">
          ...
          gerekli olan kişisel verilerinizin, bu gizlilik ve kişisel verilerin
